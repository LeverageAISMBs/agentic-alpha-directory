    ...
    return (
        <header className="relative min-h-screen flex items-center justify-center overflow-hidden hero-gradient">
            <div className="w-full max-w-4xl mx-auto px-4 text-center">
                <Reveal>
                    ...
                    <div className="mt-8 flex justify-center">
                        <a href="#directory" className="bg-indigo-600 text-white font-semibold rounded-lg px-6 py-3 transition duration-300 ease-in-out hover:bg-indigo-500 hover:scale-105">
                            Explore the Index
                        </a>
                    </div>
                </Reveal>
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2">
                <a href="#directory" aria-label="Scroll down">
